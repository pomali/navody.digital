class NotificationSubscription < ApplicationRecord
  ...
  TYPES = {
    'EpApplicationFormSubscription' => {
      brevo_list_name: 'EpApplicationFormSubscription',
    ...
    'VoteSubscription' => {
      brevo_list_name: 'VoteSubscription',
    ...
    'NextVoteSubscription' => {
      brevo_list_name: 'NextVoteSubscription',
    ...
    'NewsletterSubscription' => {
      brevo_list_name: 'NewsletterSubscription',
    ...
    'CompanyNewsletterSubscription' => {
      brevo_list_name: 'CompanyNewsletterSubscription',
    ...
    'NGOSubscription' => {
      brevo_list_name: 'NGOSubscription',
    ...
    'SelfEmployedSubscription' => {
      brevo_list_name: 'SelfEmployedSubscription',
    ...
    'CarOwnerSubscription' => {
      brevo_list_name: 'CarOwnerSubscription',
    ...
    'TaxReturnSubscription' => {
      brevo_list_name: 'TaxReturnSubscription',
  ...
  def add_email_to_list
    list_name = TYPES.dig(type, :brevo_list_name)
